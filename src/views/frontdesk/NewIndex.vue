  ...
  <div>
   ...
   <van-nav-bar title="滞留疫区无法返回教职工信息" class="ts"/>
    ...
    <van-form validate-first v-model="form">
      ...
      <van-field v-model="form.name" placeholder="请输入姓名" :rules="nameRules" />
...
<van-field v-model="form.returnLiuZhouTime" type="date"/>
      ...
      <van-field v-model="form.returnLiuZhouWay" placeholder="请输入" :rules="returnLiuZhouWayRules" />
...
export default {
  ...
  methods: {
    initForm() {
      ...
      this.$set(this.form, "returnLiuZhouTime", ""); //计划返柳时间
